...
const words = ["australia", "book", "laptop", "ambulance", "shape"];
...
const numbers = [2, 4, 1, 6, 9, 5];
function getSquare(numbers) {
    return numbers.map((num) => num * num);
}
// console.log(getSquare(numbers), "squaredarr");
// ------------------------------------------------------------------------------------------------------------------------------------------
...
function getScore(scores) {
    ...
    console.log(`the number of times score fell below the minimum score: ${minCount}`);
    console.log(`the number of times score went above the maximam score: ${maxCount}`);
}
